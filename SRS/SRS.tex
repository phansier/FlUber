...
\begin{figure}[h]
	\center{\includegraphics[width=150mm]{../Flubber Project/full.png} \\Gantt Diagram}
	\center{\includegraphics[width=150mm]{../Flubber Project/1.png} \\Gantt Diagram - Initiation Phase}
\end{figure}
‎
