...
class ChatScreenState extends State<ChatScreen> {
  ...
  Widget build(BuildContext context) {
    currentUserEmail = getCurrentUserEmail(context);
    return new Scaffold(
        appBar: new AppBar(
          title: new Text("Chat"),
        ),
  ...
  void _sendMessage({String messageText, String imageUrl}) {
    reference.push().set({
      'text': messageText,
      'email': currentUserEmail,//googleSignIn.currentUser.email,
      'imageUrl': imageUrl,
      'senderName': getCurrentUserName(context),//googleSignIn.currentUser.displayName,
      'senderPhotoUrl': getCurrentUserUrl(context),//googleSignIn.currentUser.photoUrl,
    });

    //analytics.logEvent(name: 'send_message');
  }

  //signin and auth with google account + signout
